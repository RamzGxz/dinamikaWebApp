...
const TodoList = () => {
    ...
    const backTodo = ['bg-dark', 'bg-primary', 'bg-light', 'bg-info', 'bg-success', 'bg-info', 'bg-warning']
                ...
                <div className="bg-light rounded-3 py-3">
                    ...
                    <div className="">
                        <div className="container">
                            {todoData.map(data => {
                                return (
                                    <div className="my-1 container rounded-3 py-2 d-flex align-items-center justify-content-md-between" style={{
                                        ...
                                        <div className="d-flex align-items-center">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <input type="checkbox" className="form-check-input form-check-inline ms-3 mt-0 p-3" />
                                            </div>
                                            <div className="textTodo">
                                                <p className="mb-0">{data.text}</p>
                                            </div>
                                        </div>
                                        <div className="d-flex align-items-center justify-content-center px-2 py-1 rounded-3 bg-danger">
                                            <i class="fa-regular fa-clock mb-0 fw-medium text-white" style={{ fontSize: '13px' }}></i>
                                            <p className="mb-0 ms-1 fw-medium text-white" style={{ fontSize: '14px' }}>2 Mins</p>
                                        </div>
                                    </div>
                                )
                            })}
